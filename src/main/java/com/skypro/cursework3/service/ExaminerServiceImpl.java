...
//            questions.add(questionService.get(random.nextInt(amount)).getRandomQuestion());
            questions.add(questionService.get(random.nextInt(questionService.size())).getRandomQuestion());
        }
        return questions;
    }
}
